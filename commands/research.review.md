...
2. Establish the rubric before reading deeply:
   ...
   - Infer the **paper type** (measurement / attack / defense / benchmark / systems / theory) and load its checklist from `templates/paper/<type>.md` if present; otherwise reason about the type-specific bar (e.g., benchmark papers need transparent construction, annotator agreement, baselines, and a maintenance plan).
