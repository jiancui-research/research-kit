...
> Consulted by `/research.proposal` when choosing a venue and by explicit `/research.implement paper <section>` mode for manuscript structure.
...
---
**Next**: feed the venue and paper type back to `/research.proposal`, then use `/research.implement paper <section>` with the matching skeleton.
