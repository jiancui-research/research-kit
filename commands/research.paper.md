...
1. **Read context.**
   ...
   - Determine the paper type (measurement / attack / defense / benchmark) from `idea.md`; default to the closest match and say which you chose. Load the matching skeleton from `templates/paper/<type>.md`.
...
3. **Draft the section** following the skeleton beat for that section and the constitution's voice. Apply across all sections:
