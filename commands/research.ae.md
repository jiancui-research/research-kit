...
## Completion
Report the paths written under `./.research/ae/`. This is an auxiliary command, not a pipeline stage: it runs in parallel once eval results exist, and has no next step.
