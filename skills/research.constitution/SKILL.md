...
> **research-kit stage - `/research.constitution`.**
>
> The instructions for this stage are not duplicated here. Read
> `commands/research.constitution.md` from this plugin's own directory - the folder two levels above
...
>   their free-text input for this stage (optional focus areas, e.g. "security venue, measurement, strict reproducibility). When they gave none, follow the
